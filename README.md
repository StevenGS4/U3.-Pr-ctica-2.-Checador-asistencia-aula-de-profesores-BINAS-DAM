...
Sobre la parte funcional del BD con SQLite (que valdrá 50%). Se deberá completar el CRUD de las 4 tablas, ADEMÁS de al menos 3 consultas avanzadas, por ejemplo: 

todos los profesores que tienen clase a las 8am en el edificio UD.
mostrar todos los profesores  (nombres) que asistieron el día 8/02/2022 a clase.
etc.
para manejo de fechas considere leer esta información: https://www.sqlitetutorial.net/sqlite-date/

Entregable:
Liga del proyecto en Github / DRIVE con el código de las clases. NO SUBIR EL PROYECTO COMPLETO.
